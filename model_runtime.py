...
class ModelRuntime:
    ...
    def initialize(self, cfg_path: str, save_dir: str,
        ...
        if self.model is not None:  # 已初始化
            return "✅ 模型已就绪（预加载）"
